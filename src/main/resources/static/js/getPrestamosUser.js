...
function listPrestamos(data){
							var tr = [];
	                         for (var i = 0; i < data.length; i++) {
								if( data[i].fkEmpleadoPrestamo === localStorage.id){
									...
									tr.push('<td> <a href=prestamosEditar.html?id=' + data[i].idPrestamosEmpleados + ' class="btn btn-primary"><img width="20px" src="img/modificar.png"></a></td>');
		                            tr.push('<td>');
